...
<html lang="en">
   ...
   <script type="text/javascript">
      $(document).ready(function(){
    	  let asdf = document.getElementById("updatebtn");
    	  if("${flag}" == "true"){  
...
<body style="margin: 0; padding: 0; font-family: 'Nanum Gothic Coding', monospace;">
    ...
    <main style="margin: 100px 200px auto 400px;">
        <h2 style="margin-bottom: 20px; font-weight: 700; margin-left: 15px;">${select_poster.title }</h2>
        <div class="content" style="display: block;">
          <div class="writecontent" style="font-size: 18px; margin-top: -16px; font-weight: 600; margin-left: 17px">
          	
            <span>작성자 : </span><input type="text" style="border: none;" id="writer" name="writer" value="${select_poster.author }" readonly>
          </div>
          <div class="writecontent" style="font-size: 18px; font-weight: 600; margin-left: 17px">
            <span>작성일 : </span><input type="text" style="border: none;" id="regdate" name="regdate" value="${select_poster.writer_date }" readonly>
          </div>
          <div class="writecontent" style="font-size: 18px; font-weight: 600; margin-left: 17px; display: flex;">
            조회수 : <input type="text" style="border: none; margin-left: 9px; width: 755px;" id="viewcount" name="viewcount" value="${select_poster.view_num }" readonly>
        ...
        <div class="contentbox" style="margin-top: 20px; font-size: 17px; margin-left: 97px;">
          <textarea rows="12" cols="97" style="border: 2px solid lightgray;" readonly>${select_poster.contents}</textarea>
      </div>
        <hr>
        ...
        <div class="btnwrapper" style=" display:flex; justify-content:flex-end; margin-right: 350px;">
          <a href="list.do"><button type="button" id="back" style="width: 90px; height: 38px; border-radius: 8px; border: none; font-weight: 600; margin-right:10px;">취소</button></a>
          <a href="view_update.do?poster_pk=${select_poster.poster_pk }"><button type="button" id="updatebtn" style="width: 90px; height: 38px; border-radius: 8px; border: none; font-weight: 600; margin-right:10px; background-color: #0C98FD; color: #fff;">수정</button></a>
          <a href="#"><button type="button" id="regist" style="width: 90px; height: 38px; border-radius: 8px; border: none; font-weight: 600; background-color: #0C98FD; color: #fff;" >등록</button></a>
        </div>
