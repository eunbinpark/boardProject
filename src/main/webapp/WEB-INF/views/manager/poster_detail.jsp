    ...
    <main style="margin: 100px 200px auto 400px;">
        ...
        <div class="content" style="display: block;">
          <div class="writecontent" style="font-size: 18px; margin-top: -16px; font-weight: 600; margin-left: 17px">
            <span>작성자 : </span><input type="text" style="border: none;" id="writer" name="writer" value="${select_poster.author }">
          </div>
          <div class="writecontent" style="font-size: 18px; font-weight: 600; margin-left: 17px">
            <span>작성일 : </span><input type="text" style="border: none;" id="regdate" name="regdate" value="${select_poster.writer_date }">
          </div>
          <div class="writecontent" style="font-size: 18px; font-weight: 600; margin-left: 17px; display: flex;">
            조회수 : <input type="text" style="border: none; margin-left: 9px; width: 755px;" id="viewcount" name="viewcount" value="${select_poster.view_num }">
        ...
        <div class="contentbox" style="margin-top: 20px; font-size: 17px; margin-left: 97px;">
          <textarea rows="12" cols="97" style="border: 2px solid lightgray;">${select_poster.contents}</textarea>
      </div>
        <hr>
        ...
        <div class="btnwrapper" style="text-align: right; margin-right: 330px;">
          ...
          <button type="button" id="updatebtn" style="width: 90px; height: 38px; border-radius: 8px; border: none; font-weight: 600; background-color: #0C98FD; color: #fff;">수정</button>
          <button type="button" id="regist" style="width: 90px; height: 38px; border-radius: 8px; border: none; font-weight: 600; background-color: #0C98FD; color: #fff;" >등록</button>
        </div>
