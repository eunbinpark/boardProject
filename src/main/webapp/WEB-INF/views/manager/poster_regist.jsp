    ...
    <main style="margin: 150px 200px auto 400px;">
        ...
        <div class="mainwrapper">
            <div class="inputbox" style="width: 1000px; height: 50px; font-size: 18px; font-weight: 600; margin-left: 17px;">
                <span style="margin-left: 18px;">제목 : </span><input type="text" id="title" name="title" placeholder="제목을 입력하세요" style="width: 90%; height: 100%; border: none; border-bottom: 2px solid lightgray;">
            </div>
            <div class="writecontent" style="font-size: 18px; margin-top: 20px; font-weight: 600; margin-left: 17px">
                작성자 : <input type="text" style="border: none;" id="writer" name="author" value="${login_user.user_id}" readonly>
            </div>
            
            <div class="contentbox" style="margin-top: 20px; font-size: 17px; margin-left: 97px;">
                <textarea name="contents" rows="12" cols="97" style="border: 2px solid lightgray;" placeholder="내용을 입력하세요"></textarea>
            </div>
        </div>
        <div class="btnwrapper" style="text-align: right; margin-right: 330px;">
            ...
            <button id="registbtn" type="button" style="width: 90px; height: 38px; border-radius: 8px; border: none; font-weight: 600; background-color: #0C98FD; color: #fff;">등록</button>
        </div>
    </main>
</form>
</body>
