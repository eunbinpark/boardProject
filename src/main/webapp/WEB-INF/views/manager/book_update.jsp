...
<body style="margin: 0; padding: 0; font-family: 'Nanum Gothic Coding', monospace;">
    ...
    <main style="margin: 150px 200px auto 400px;">
        <h1 style="margin-bottom: 20px; font-weight: 700; margin-left: 57px;">글 수정하기</h1>
		<form action="" method="post" id='frm'>
	        <div class="mainwrapper">
	            <div class="inputbox" style="width: 1000px; height: 50px; font-size: 18px; font-weight: 600; margin-left: 17px;">
	                <span style="margin-left: 10px; background: linear-gradient(to top, #B9F3FC 50%, transparent 50%);">제 목 :</span>
	                <input type="text" id="title" name="title" value="제목을 입력하세요" style="width: 90%; height: 100%; border: 2px solid lightgray;">
	            </div>
	            <div class="writecontent" style="font-size: 18px; margin-top: 20px; font-weight: 600; margin-left: 17px">
	                <span style="background: linear-gradient(to top, #B9F3FC 50%, transparent 50%);">작성자 :</span>
	                <input type="text" style="border: none;" id="writer" name="writer" value="" readonly>
	            </div>
	        ...
	        <div class="btnwrapper" style="text-align: right; margin-right: 330px;">
	            ...
	            <button type="submit" style="width: 90px; height: 38px; border-radius: 8px; border: none; font-weight: 600; background-color: #0C98FD; color: #fff;">수정</button>
	        </div>
	    </form>
    </main>
</body>
